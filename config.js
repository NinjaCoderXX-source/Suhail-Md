...
//═══════[Required Variables]════════\\
global.audio= "https://vocaroo.com/1cVnooBvtEY7" ;  
global.video= "" ;
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/adb301df693b5aa080346.jpg" ; // SET LOGO FOR IMAGE 
...
module.exports = {
  ...
  caption : global.caption || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴠɪʜᴀɴɢᴀ-ᴍᴅ" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜʜᴀɪʟ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
 
  author : process.env.PACK_AUTHER|| "ᴘᴏᴡᴇʀᴇᴅ ʙʏ",
  packname: process.env.PACK_NAME || "ᴠɪʜᴀɴɢᴀ-ᴍᴅ",
  botname : process.env.BOT_NAME  || "ᴠɪʜᴀɴɢᴀ-ᴍᴅ",
